...
(define d0 (to-double 0.0))
(define d1 (to-double 1.0))



(overload-procedure random 
		    (lambda () (to-double (java.lang.Math:random))) 
		    ())
...
(define (uniform-dummy dummy1 dummy2) (to-double {-1.0 + (random) * 2.0}))
